...
$PolicyName = "aws-opsworks-cm-chef"
$PolicyDescription = "Allows adding of OpsWorks for Chef Automate nodes"
$RoleName = "aws-opsworks-cm-chef"
$RoleDescription = "Allows adding of OpsWorks for Chef Automate nodes"
...
# Version history:
#   2018-04-24 - v1.0 - Initial version
#
# Execute remotely by running:
#   Invoke-Expression (New-Object System.Net.WebClient).DownloadString("https://raw.githubusercontent.com/PowerSix/MyPowerShellSpace/master/New-IAMChefRole.ps1")
#
